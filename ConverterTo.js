...
const ConverterTo = (props) => {
    ...
    const renderItem = ({ item }) => (
        <TouchableOpacity onPress={() => props.handleTouchPress("to", item.currency)} style={styles.flatListItem}>
    ...
    return(
        <View style={[styles.inputItem, styles.shadow]}>
            <Text style={styles.textInput}>{props.result}</Text>
            <TouchableOpacity style={styles.modal} onPress={() => props.handleVisibility('to')}>
